...
<body>
    <header class="header">
        ...
        <!-- Ajouter les éléments manquants pour searchbar.js -->
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg">
            <ul class="flex flex-col items-center gap-4 py-4">
                <li><a href="index.php?c=home&m=index" class="nav-link">Accueil</a></li>
                <li><a href="index.php?c=products&m=index" class="nav-link">Produits</a></li>
                <li><a href="index.php?c=about&m=index" class="nav-link">À propos</a></li>
            </ul>
        </div>
    ...
    <main id="BodyLine" class="page-<?php echo htmlspecialchars($pageClass); ?>">
        <?php echo $content; ?>
    </main>
