...
// Charger les fichiers nécessaires (si pas déjà fait)
...
// Déterminer la ressource demandée
$resource = $_GET['resource'] ?? 'home';

// Afficher le lien "Admin" uniquement si l'utilisateur est connecté et a le bon rôle
