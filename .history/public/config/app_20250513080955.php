...
require_once __DIR__ . '/../vendor/'; // Chemin vers l'autoloader si installé via Composer

// Charger la configuration de la base de données
require_once __DIR__ . '/../Public/config/database.php'; // Ajustez selon l'emplacement réel
