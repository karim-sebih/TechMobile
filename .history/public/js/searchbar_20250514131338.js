...
searchSubmit.addEventListener('click', () => {
    ...
    if (query) {
        // Rediriger vers une page de recherche ou filtrer les produits
...
function updateCart() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            ...
            cartItemElement.innerHTML = `/* faire un template,avec fetch  */
...
// Mettre à jour le panier au démarrage pour refléter les données de localStorage
updateCart();
