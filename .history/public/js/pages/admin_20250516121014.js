...
function setupFormSubmission() {
    const form = document.querySelector('form[action="index.php?resource=admin"]');
    if (form) {
...
// Fonction d'initialisation pour PageLoader.js
export function init() {
    console.log('Initialisation de admin.js');
    ...
    const messageClose = document.querySelector('.message-popup .message-close');
    const messageOk = document.querySelector('.message-popup button');
    if (messageClose) {
        messageClose.addEventListener('click', hideMessagePopup);
    }
    if (messageOk) {
        messageOk.addEventListener('click', hideMessagePopup);
    }
    setupFormSubmission();
}