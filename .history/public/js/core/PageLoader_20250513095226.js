...
async function loadPageStyle(filename, filepath) {
    const adjustedFilepath = `/TechMobile/Public/css/${filename}.css`; // Chemin corrigé pour CSS
...
async function loadPageScript(filepath, args = []) {
    const importPath = `/TechMobile/Public/js/pages/${filepath}`; // Chemin corrigé pour JS
