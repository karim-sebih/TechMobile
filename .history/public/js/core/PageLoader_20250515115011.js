import { MAIN_ID } from '../config.js'; // Changé de MAIN_CONTAINER à MAIN_ID

// Ajout de débogage
console.log('PageLoader.js chargé, MAIN_ID:', MAIN_ID);

const MAIN_CONTAINER = document.getElementById(MAIN_ID); // Ajouté pour définir MAIN_CONTAINER à partir de MAIN_ID
...
async function displayPageHTML(html) {
    MAIN_CONTAINER.innerHTML = html; // Utilise MAIN_CONTAINER défini ci-dessus
}
...
// Dans la fonction loadPage (ajouter ce cas)
case 'admin':
    fetchPage('admin.php', '#BodyLine');
    break;