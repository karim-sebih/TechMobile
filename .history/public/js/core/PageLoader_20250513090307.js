...
async function getApiContent(resource) {
    ...
    console.log('URL appelée:', `${ROUTER_PATH}?resource=${encodeURIComponent(resource)}`);
    try {
...
console.log('Chemin complet pour CSS:', `/css/${page}.css`);
console.log('Chemin complet pour JS:', `/js/pages/${filepath}`);