...
export function showPageloader() {
    console.log('Affichage du pageloader');
    // Logique pour afficher un loader (à implémenter selon ton design)
}

export function hidePageloader() {
    console.log('Masquage du pageloader');
    // Logique pour masquer un loader (à implémenter selon ton design)
}