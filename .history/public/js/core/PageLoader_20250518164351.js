...
export async function loadPage(page, args = []) {
    ...
    // Ré-attacher l'écouteur submit après chaque chargement de page
...
// Fonction pour attacher l'écouteur submit
function attachFormSubmitListener() {
    console.log('Attache de l\'écouteur submit aux formulaires');
    document.querySelectorAll('form').forEach(form => {
        form.removeEventListener('submit', handleFormSubmit); // Éviter les doublons
