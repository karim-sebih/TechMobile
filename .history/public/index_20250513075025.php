...
// Vérifier si c'est une requête AJAX (PageLoader.js envoie une requête GET avec 'resource')
if (isset($_GET['resource'])) {
    ...
    exit; // Terminer l'exécution après avoir envoyé la réponse JSON
}

// Si ce n'est pas une requête AJAX, afficher le HTML
?>
