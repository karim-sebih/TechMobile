...
$databasePath = __DIR__ . '\..\config\database.php'; // Chemin corrigé avec \ pour Windows
if (!file_exists($databasePath)) {
    die('Erreur : database.php non trouvé à ' . $databasePath);
}
$productModelPath = __DIR__ . '\..\..\App\Models\ProductComponentItems.php'; // Chemin corrigé avec \
