...
try {
    ...
    error_log("home.php - Erreur lors de l'initialisation ou récupération des produits : " . $e->getMessage());
    $products = []; // Continuer avec un tableau vide
}
?>
        ...
        <div class="products-list">
            <?php foreach ($products as $product): ?>
                <div class="product-item">
                    <h3><?php echo htmlspecialchars($product['name'] ?? 'Nom non défini'); ?></h3>
                    <p>Prix : <?php echo htmlspecialchars($product['price'] ?? '0') . ' €'; ?></p>
                    <button class="add-to-cart" 
                            data-id="<?php echo $product['id'] ?? 0; ?>" 
