...
// Vérifier les fichiers avec les chemins originaux
$databasePath = __DIR__ . '/../config/database.php'; // Retour au chemin original
if (!file_exists($databasePath)) {
    die('Erreur : database.php non trouvé à ' . $databasePath);
}
$productModelPath = __DIR__ . '/../../App/Models/ProductComponentItems.php'; // Retour au chemin original
