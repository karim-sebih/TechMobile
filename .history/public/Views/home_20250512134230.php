...
try {
    ...
    if (empty($products)) {
        ...
        // Ajout d'un test direct pour confirmer
        ...
        error_log("home.php - Résultats directs de la base : " . json_encode($directResults));
        echo "<p>Résultats directs (débogage) : <pre>" . print_r($directResults, true) . "</pre></p>";
    }
} catch (Exception $e) {
