    ...
    <div class="products-list">
        ...
        if (!empty($products)) {
            foreach ($products as $product) {
                ...
                echo '<button class="add-to-cart" data-id="' . $product['proid'] . '" data-name="' . htmlspecialchars($product['name']) . '" data-price="' . $product['price'] . '" data-image="' . $imageUrl . '">Ajouter au panier</button>';
                echo '</div>';
            }
        } else {
