...
try {
    ...
    error_log("home.php - ProductComponentItems initialisé");
} catch (Exception $e) {
    error_log("home.php - Erreur initialisation : " . $e->getMessage());
    echo "<p>Erreur initialisation : " . htmlspecialchars($e->getMessage()) . "</p>";
    exit;
}
...
try {
    ...
    error_log("home.php - Erreur produits : " . $e->getMessage());
    $products = [];
}
?>
