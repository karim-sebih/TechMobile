<?php
// Initialiser ProductComponentItems
try {
    ProductComponentItems::init();
    error_log("home.php - ProductComponentItems initialisé avec succès");
} catch (Exception $e) {
    error_log("home.php - Erreur lors de l'initialisation de ProductComponentItems : " . $e->getMessage());
...
<div class="featured-products">
    ...
    <?php
    try {
        $featuredProducts = ProductComponentItems::findByFilters(['is_featured' => 1, 'limit' => 4]);
        error_log("home.php - Produits phares récupérés : " . json_encode($featuredProducts));
    ...
    <?php catch (Exception $e) {
        error_log("home.php - Erreur lors de la récupération des produits phares : " . $e->getMessage());
        echo "<p>Erreur lors de la récupération des produits phares : " . htmlspecialchars($e->getMessage()) . "</p>";
    } ?>
</div>
...
<div class="brand">
    ...
    <img src="https://download.logo.wine/logo/Xiaomi/Xiaomi-Logo.wine.png" alt="Logo Xiaomi" class="brand-logo">
</div>
