...
error_log('Nombre de marques: ' . count($brands));
error_log('Nombre de catégories: ' . count($categories));

// Générer les options pour les marques
$brandOptions = '';
foreach ($brands as $brand) {
    $brandOptions .= '<option value="' . htmlspecialchars($brand['brand_id']) . '">' . htmlspecialchars($brand['brand_name']) . '</option>';
}

// Générer les options pour les catégories
$categoryOptions = '';
foreach ($categories as $category) {
    $categoryOptions .= '<option value="' . htmlspecialchars($category['category_id']) . '">' . htmlspecialchars($category['category_name']) . '</option>';
}
