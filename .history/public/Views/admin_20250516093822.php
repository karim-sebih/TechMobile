            ...
            <tbody>
                <?php if (!empty($products)): ?>
                    <?php foreach ($products as $product): ?>
                        <tr>
                            <td><img src="<?php echo htmlspecialchars($product['image_url'] ?: 'https://via.placeholder.com/150'); ?>" alt="<?php echo htmlspecialchars($product['product_name']); ?>"></td>
                            <td><?php echo htmlspecialchars($product['product_name']); ?></td>
                            <td><?php echo htmlspecialchars($product['price']); ?> €</td>
                            <td><?php echo $product['is_active'] ? 'Actif' : 'Inactif'; ?></td>
                            <td>
                                <a href="index.php?resource=edit_product&id=<?php echo $product['product_id']; ?>" class="btn">Modifier</a>
                                <a href="index.php?resource=delete_product&id=<?php echo $product['product_id']; ?>" class="btn" onclick="return confirm('Supprimer ce produit ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
