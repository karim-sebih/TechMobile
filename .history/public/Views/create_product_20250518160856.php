...
<body>
    <div class="content">
        ...
        <!-- Formulaire de test local -->
        <form method="POST" action="">
            <div class="form-group">
                <label for="product_name">Nom :</label>
                <input type="text" id="product_name" name="product_name" value="Test Local" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="sku" name="sku" value="TEST-LOCAL-001" required>
            </div>
            <div class="form-group">
