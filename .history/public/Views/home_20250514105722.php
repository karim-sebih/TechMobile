    ...
    <div class="products-list">
        ...
        if (!empty($products)) {
            foreach ($products as $product) {
                // Utiliser l'image de product_images si disponible, sinon une image par défaut
                ...
                echo '<button class="add-to-cart" data-id="' . $product['product_id'] . '" data-name="' . htmlspecialchars($product['product_name']) . '" data-price="' . $product['price'] . '">Ajouter au panier</button>';
                echo '</div>';
            }
        } else {
